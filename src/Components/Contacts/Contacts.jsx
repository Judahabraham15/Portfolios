    ...
    <div className='contacts' id='contact'>
      ...
      <div className="contacts-grid">
        ...
        >
          ...
          <form className='contact-form'>
            ...
            <div className="contact-forms">
              <textarea type='text' className='text-area' placeholder='Hey Judah, are you up for this role?' />
            </div>
            <motion.span
              className='text-btn'
      ...
      <div className="popup">
        <div className="pop-card">
          <HiBadgeCheck size={18} color="black" style = {{verticalAlign : "middle", marginRight:'5px'}} />  <p>Message Sent 💚! </p>
        </div>
      </div>
    </div>
  )
