  ...
  const Timelines = [
    {
      ...
      desc: "Began my coding journey in 2022, learning HTML and CSS.",
      side: "left",
      icon: <FaCode color="#218838" />,
      text: "Click Icon to View Certificate",
      icons: (
        <HiBadgeCheck
          size={18}
          color="#2e8b57"
  ...
  const Education = [
    {
      ...
      desc: "SMC College",
      side: "left",
      icon: <FaSchool color="#218838" />,
      iconic: <FaRegCalendarAlt color="grey" size={20} />,
      texts: "2010 - 2024",
    },
    {
      title: "B.sc Mass Comm",
      desc: "Lagos State University",
      side: "right",
      icon: <FaBroadcastTower color="#218838" />,
      iconic: <FaRegCalendarAlt color="grey" size={20} />,
      texts: "2025 - Present",
    },
    {
      title: "Web Development",
      desc: "Learning and Practicing",
      side: "left",
      icon: <FaLaptopCode color="#218838" />,
      texts: "2024 - Present",
      iconic: <FaRegCalendarAlt color="grey" size={20} />,
  ...
  return (
    <div className="container" id="qualifications">
      ...
      >
        <h1>Experience</h1>
        <p>
          Judah<span className="dev">4Good's</span> Journey
        </p>
      ...
      <div className="timeline" style={{ position: "relative" }}>
        ...
        <div className="timeline-contain">
          {(activeTab === "Experience" ? Timelines : Education).map(
            ({ title, desc, side, icon, text, texts, icons, iconic }, idx) => (
              <motion.div
              ...
              >
                ...
                <div className="div" style={{ margin: "0" }}>
                  ...
                  <p
                    style={{ fontSize: "18px", color: "grey", margin: "0" }}
                    className="tit"
                  >
                    {texts}
                  </p>
                ...
                <p>
                  {text}{" "}
                  <a
                    href="https://www.udemy.com/certificate/UC-79960699-3110-46ac-9c86-899685284c83/"
                    target="_blank"
                  >
                    {icons}
                  </a>
