    ...
    >
      <div className="relative max-w-3xl mx-auto py-30">
        ...
        <div className="px-4 sm:px-8">
          ...
          <div className="rounded-xl border border-gray-200 p-6.5 bg-[#dcf2e3]">
            <span className="text-base font-bold font-inter flex items-center gap-2">
              Description
              <span className="text-green-500 bg-green-100 px-3 py-1 rounded-lg transition-colors duration-300 ease-in hover:bg-gray-300">
                !
              </span>
            </span>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {project.technologies?.map((tech, idx) => (
                  <span
                    key={idx}
                    className="bg-[#a8fc93] px-4 rounded-md py-1.5 text-green-800 font-outfit font-medium"
                  >
                    {tech}
                  </span>
                ))}
          ...
          <div className="relative w-full h-full bg-gradient-to-br from-green-100 to-white rounded-[18px] p-7 shadow-[0_20px_40px_rgba(16,185,129,0.12),_0_6px_10px_rgba(0,0,0,0.06)] mt-10">
